...
void ControladorSistema::pagoDebito(int asientos, std::string banco, int funcion, int cine, int total)
{
...
void ControladorSistema::pagoCredito(int asientos, std::string financiera, int funcion, int cine, int total)
{
    //MOMENTANEAMENTE COMO NO TENEMOS UN MONTO PARA EL TOTAL, DIREMOS QUE EL PRECIO ESTA A 250 PESOS
