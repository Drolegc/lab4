...
${OBJECTDIR}/classes/interfaces/ControladorSistema.o: classes/interfaces/ControladorSistema.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/interfaces/ControladorSistema.o classes/interfaces/ControladorSistema.cpp
...
${OBJECTDIR}/classes/sources/Cine.o: classes/sources/Cine.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/sources/Cine.o classes/sources/Cine.cpp

${OBJECTDIR}/classes/sources/Credito.o: classes/sources/Credito.cpp
	${MKDIR} -p ${OBJECTDIR}/classes/sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/sources/Credito.o classes/sources/Credito.cpp

${OBJECTDIR}/classes/sources/Debito.o: classes/sources/Debito.cpp
	${MKDIR} -p ${OBJECTDIR}/classes/sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/sources/Debito.o classes/sources/Debito.cpp

${OBJECTDIR}/classes/sources/Funcion.o: classes/sources/Funcion.cpp
	${MKDIR} -p ${OBJECTDIR}/classes/sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/sources/Funcion.o classes/sources/Funcion.cpp

${OBJECTDIR}/classes/sources/Pelicula.o: classes/sources/Pelicula.cpp
	${MKDIR} -p ${OBJECTDIR}/classes/sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/sources/Pelicula.o classes/sources/Pelicula.cpp

${OBJECTDIR}/classes/sources/Reserva.o: classes/sources/Reserva.cpp
	${MKDIR} -p ${OBJECTDIR}/classes/sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/sources/Reserva.o classes/sources/Reserva.cpp

${OBJECTDIR}/classes/sources/Sala.o: classes/sources/Sala.cpp
	${MKDIR} -p ${OBJECTDIR}/classes/sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/sources/Sala.o classes/sources/Sala.cpp
...
${OBJECTDIR}/datatypes/sources/DtDireccion.o: datatypes/sources/DtDireccion.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datatypes/sources/DtDireccion.o datatypes/sources/DtDireccion.cpp
